...
public class CustomWindow extends Activity {
    ...
    public void toggleWatchedMovie(long rowId, int watched) {
    	...
    	int rows = getContentResolver().update(uri, newValue, MovieDefinitions.MovieDefinition.KEY_ROWID + "=?", new String[]{Long.toString(rowId)});
    	Log.i("toggleWatchedMovie", rows + " " + rowId + " " + watched);
    }
